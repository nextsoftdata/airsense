...
if ($result4->num_rows > 0) {
    ...
    echo "Calitate aer minima/24h: " . $row4["MIN(calitateaer)"]. "*C"  . "<br>"; 
...
if ($result2->num_rows > 0) {
    ...
    echo "Calitate aer medie/24h: " . $row2["AVG(calitateaer)"]. "*C"  . "<br>";
...
if ($result6->num_rows > 0) {
    ...
    echo "Calitate aer maxima/24h: " . $row6["MAX(calitateaer)"]. "*C"  . "<br>";
...
if ($result4->num_rows > 0) {
    ...
    while($row4 = $result4->fetch_assoc()) {
    echo "Calitate aer minima/luna: " . $row4["MIN(calitateaer)"]. "*C"  . "<br>"; 
...
if ($result2->num_rows > 0) {
    ...
    while($row2 = $result2->fetch_assoc()) {
    echo "Calitate aer medie/luna: " . $row2["AVG(calitateaer)"]. "*C"  . "<br>";
...
if ($result6->num_rows > 0) {
    ...
    while($row6 = $result6->fetch_assoc()) {
    echo "Calitate aer maxima/luna: " . $row6["MAX(calitateaer)"]. "*C"  . "<br>";
...
if ($result4->num_rows > 0) {
    ...
    while($row4 = $result4->fetch_assoc()) {
    echo "Calitate aer minima/an: " . $row4["MIN(calitateaer)"]. "*C"  . "<br>"; 
...
if ($result2->num_rows > 0) {
    ...
    while($row2 = $result2->fetch_assoc()) {
    echo "Calitate aer medie/an: " . $row2["AVG(calitateaer)"]. "*C"  . "<br>";
...
if ($result6->num_rows > 0) {
    ...
    while($row6 = $result6->fetch_assoc()) {
    echo "Calitate aer maxima/an: " . $row6["MAX(calitateaer)"]. "*C"  . "<br>";
...
if ($result4->num_rows > 0) {
    ...
    while($row4 = $result4->fetch_assoc()) {
    echo "Presiune minima/24h: " . $row4["MIN(presiune)"]. "*C"  . "<br>"; 
...
if ($result2->num_rows > 0) {
    ...
    while($row2 = $result2->fetch_assoc()) {
    echo "Presiune medie/24h: " . $row2["AVG(presiune)"]. "*C"  . "<br>";
...
if ($result6->num_rows > 0) {
    ...
    while($row6 = $result6->fetch_assoc()) {
    echo "Presiune maxima/24h: " . $row6["MAX(presiune)"]. "*C"  . "<br>";
...
if ($result4->num_rows > 0) {
    ...
    while($row4 = $result4->fetch_assoc()) {
    echo "Presiune minima/luna: " . $row4["MIN(presiune)"]. "*C"  . "<br>"; 
...
if ($result2->num_rows > 0) {
    ...
    while($row2 = $result2->fetch_assoc()) {
    echo "Presiune medie/luna: " . $row2["AVG(presiune)"]. "*C"  . "<br>";
...
if ($result6->num_rows > 0) {
    ...
    while($row6 = $result6->fetch_assoc()) {
    echo "Presiune maxima/luna: " . $row6["MAX(presiune)"]. "*C"  . "<br>";
...
if ($result4->num_rows > 0) {
    ...
    while($row4 = $result4->fetch_assoc()) {
    echo "Presiune minima/an: " . $row4["MIN(presiune)"]. "*C"  . "<br>"; 
...
if ($result2->num_rows > 0) {
    ...
    while($row2 = $result2->fetch_assoc()) {
    echo "Presiune medie/an: " . $row2["AVG(presiune)"]. "*C"  . "<br>";
...
if ($result6->num_rows > 0) {
    ...
    while($row6 = $result6->fetch_assoc()) {
    echo "Presiune maxima/an: " . $row6["MAX(presiune)"]. "*C"  . "<br>";
...
if ($result4->num_rows > 0) {
    ...
    while($row4 = $result4->fetch_assoc()) {
    echo "Umiditate minima/24h: " . $row4["MIN(umiditate)"]. "*C"  . "<br>"; 
...
if ($result2->num_rows > 0) {
    ...
    while($row2 = $result2->fetch_assoc()) {
    echo "Umiditate medie/24h: " . $row2["AVG(umiditate)"]. "*C"  . "<br>";
...
if ($result6->num_rows > 0) {
    ...
    while($row6 = $result6->fetch_assoc()) {
    echo "Umiditate maxima/24h: " . $row6["MAX(umiditate)"]. "*C"  . "<br>";
...
if ($result4->num_rows > 0) {
    ...
    while($row4 = $result4->fetch_assoc()) {
    echo "Umiditate minima/luna: " . $row4["MIN(umiditate)"]. "*C"  . "<br>"; 
...
if ($result2->num_rows > 0) {
    ...
    while($row2 = $result2->fetch_assoc()) {
    echo "Umiditate medie/luna: " . $row2["AVG(umiditate)"]. "*C"  . "<br>";
...
if ($result6->num_rows > 0) {
    ...
    while($row6 = $result6->fetch_assoc()) {
    echo "Umiditate maxima/luna: " . $row6["MAX(umiditate)"]. "*C"  . "<br>";
...
if ($result4->num_rows > 0) {
    ...
    while($row4 = $result4->fetch_assoc()) {
    echo "Umiditate minima/an: " . $row4["MIN(umiditate)"]. "*C"  . "<br>"; 
...
if ($result2->num_rows > 0) {
    ...
    while($row2 = $result2->fetch_assoc()) {
    echo "Umiditate medie/an: " . $row2["AVG(umiditate)"]. "*C"  . "<br>";
...
if ($result6->num_rows > 0) {
    ...
    while($row6 = $result6->fetch_assoc()) {
    echo "Umiditate maxima/an: " . $row6["MAX(umiditate)"]. "*C"  . "<br>";
