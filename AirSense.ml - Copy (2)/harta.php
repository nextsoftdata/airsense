...
if ($result2->num_rows > 0) {
	...
	if($row["calitateaer"]>=90){
		 ...
		 $textcalitateaer="Stare buna";
		 		 	...
		 		 	if($row["calitateaer"]>=60 AND $row["nivel"]<70){
		 $textcalitateaer="Stare normala";
		 		 		 	...
		 		 		 	if($row["calitateaer"]>=50 AND $row["nivel"]<60){
		 $textcalitateaer="Stare satisfacatoare";
		 		 		 		 	...
		 		 		 		 	if($row["calitateaer"]>=40 AND $row["nivel"]<50){
		 $textcalitateaer="Stare nesatisfacatoare";
		 		 		 		 		 	...
		 		 		 		 		 	if($row["calitateaer"]>=20 AND $row["nivel"]<40){
