...
//selectez din baza de date doar inregistrarile din ultima zi.
  $result = $mysqli->query('SELECT * FROM airsense WHERE airsense.data>DATE_SUB(CURDATE(), INTERVAL 1 YEAR)');
...
$mysqli->close();
  ...
  $table['cols'] = array(
    ...
    array('label' => 'rezistenta', 'type' => 'number'),
...
//creeare tabel cu datele preluate (json)
      ...
      var options = {
           title: 'Evolutia puritatii aerului in ultimul an:',
          is3D: 'true',
          width: 600,
          height: 250,
		  		  colors: ['#FF00FF'],
